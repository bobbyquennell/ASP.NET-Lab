...
namespace Test
{
    ...
    public class Class1
    {
        ...
        [Test]
        public void test_X_equals_to_1()
        {
            //arrange
            var sut = new Solution();
        ...
        [Test]
        public void cannot_accross_the_river()
        {
            //arrange
            var sut = new Solution();
            int[] A = new int[] { 1, 2, 5, 1, 3, 2, 1, 5 };
            int x = 5;
            //act
            var result = sut.solution(x, A);
            //assert

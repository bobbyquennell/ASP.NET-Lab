namespace GPA.Web.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GPA.Web.Modelss.EfRepository>
    {
        ...
        protected override void Seed(GPA.Web.Modelss.EfRepository context)
        {

...
{// this class combined too much stuff together, the restaurant name,the reviews
    ...
    //}
    public class RestaurantReview:IValidatableObject//Custom Validation way2: IValidatableObject approach
    {
        ...
        {
            if(Rating < 2 && Reviewer.ToLower().Contains("fuck"))
            {yield return new ValidationResult("You cannot do this");}
        }
    }
}